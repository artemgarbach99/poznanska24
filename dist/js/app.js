(() => {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".seminar__slider")) new core(".seminar__slider", {
            ...
            if (document.querySelector(".images-obrazy__trambs")) {
                const thumbsSwiper = new core(".images-obrazy__trambs", {
                ...
                new core(".images-obrazy__slider", {
                    modules: [ Navigation, Thumb ],
                    observer: true,
                    observeParents: true,
                    direction: "horizontal",
        ...
        da.init();
        let items = document.querySelectorAll(".mail__inner");
        items.forEach((item => {
        ...
        const cursorFade = document.querySelector(".cursor-fade");
        document.addEventListener("mousemove", moveCursor);
        document.addEventListener("click", (() => {
            cursorFade.classList.add("expand");
            setTimeout((() => {
                cursorFade.classList.remove("expand");
            }), 500);
        }));
        ...
        let buttonLink = Array.from(document.querySelectorAll("button"));
        buttonLink.forEach((btn => {
        ...
        let buttonInner = Array.from(document.querySelectorAll(".mail__inner"));
        buttonInner.forEach((inner => {
        ...
        let spanInner = Array.from(document.querySelectorAll(".span-active"));
        spanInner.forEach((inner => {
            inner.addEventListener("mouseover", (() => {
                cursor.classList.add("active");
            }));
            inner.addEventListener("mouseleave", (() => {
        ...
        document.getElementById("header__arrow").onclick = function() {
            document.getElementById("header__dropdown").classList.toggle("dropdown-open");
        };
        let linkExpand = Array.from(document.querySelectorAll(".link"));
        ...
        window.addEventListener("scroll", (() => {
            if (document.querySelector("body").classList.contains("filter-action")) {
                const filter = document.querySelector(".filter-pictures-mobile");
                ...
                let scrollDistance = window.scrollY;
                if (scrollDistance >= mainBlockHeight) filter.classList.add("filter-fixed"); else filter.classList.remove("filter-fixed");
